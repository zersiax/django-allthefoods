...
ALLOWED_HOSTS = env.list(
    "DJANGO_ALLOWED_HOSTS", default=["allthefoods.florianbeijers.xyz"]
)
...
DEFAULT_FROM_EMAIL = env(
    ...
    default="allTheFoods <noreply@allthefoods.florianbeijers.xyz>",
)
...
EMAIL_SUBJECT_PREFIX = env(
    "DJANGO_EMAIL_SUBJECT_PREFIX", default="[allTheFoods]"
)
